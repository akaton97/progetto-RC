...
Object.defineProperty(exports, "TabsCompatibility", {
  enumerable: true,
  get: function get() {
...
Object.defineProperty(exports, "ImageFormat", {
  enumerable: true,
  get: function get() {
    return _extensionTypes.ImageFormat;
  }
});
Object.defineProperty(exports, "RunAt", {
  enumerable: true,
  get: function get() {
    return _extensionTypes.RunAt;
  }
});
exports.default = exports.Tabs = exports.ZoomSettingsScope = exports.ZoomSettingsMode = exports.MutedInfoReason = exports.Tab = exports.WindowType = exports.TabStatus = void 0;

var _isNil = _interopRequireDefault(require("lodash/isNil"));

var _tabs = _interopRequireDefault(require("mdn-browser-compat-data/webextensions/api/tabs.json"));
...
var _extensionTypes = require("./extensionTypes");
...
function (_Base) {
  ...
  function Tab(instance) {
    ...
    _this = _possibleConstructorReturn(this, (Tab.__proto__ || Object.getPrototypeOf(Tab)).call(this, options));
...
Object.defineProperty(Tab, "Prefix", {
  configurable: true,
  enumerable: true,
  writable: true,
  value: false
});
Object.defineProperty(Tab, "Compatibility", {
  configurable: true,
  enumerable: true,
  writable: true,
  value: _tabs.default
});
Object.defineProperty(Tab, "Standard", {
  configurable: true,
  enumerable: true,
  writable: true,
  value: ['hidden']
...
function (_Base2) {
  ...
  function Tabs() {
    ...
    _this2 = _possibleConstructorReturn(this, (Tabs.__proto__ || Object.getPrototypeOf(Tabs)).call(this, options)); // region Events
    ...
    _this2.onActivated = new _event.default(_this2, 'onActivated');
    /**
     * Fires when the selected tab in a window changes.
     * &nbsp
     * Note that the tab's URL may not be set at the time this event fired, but you can listen to {@link onUpdated}
    ...
    _this2.onActiveChanged = new _event.default(_this2, 'onActiveChanged');
    /**
     * Fired when a tab is attached to a window, for example because it was moved between windows.
     *
     * @see {@link https://developer.chrome.com/extensions/tabs#event-onAttached}
    ...
    _this2.onAttached = new _event.default(_this2, 'onAttached');
    /**
     * Fired when a tab is created.
     * &nbsp
     * Note that the tab's URL may not be given its final value at the time this event fired. In particular,
    ...
    _this2.onCreated = new _event.default(_this2, 'onCreated');
    /**
     * Fired when a tab is detached from a window, for example because it is being moved between windows.
     *
     * @see {@link https://developer.chrome.com/extensions/tabs#event-onDetached}
    ...
    _this2.onDetached = new _event.default(_this2, 'onDetached');
    /**
     * Fired when the highlighted or selected tabs in a window changes.
     * &nbsp
    ...
    _this2.onHighlightChanged = new _event.default(_this2, 'onHighlightChanged');
    /**
     * Fired when the set of highlighted tabs in a window changes.
     * &nbsp
    ...
    _this2.onHighlighted = new _event.default(_this2, 'onHighlighted');
    /**
     * Fired when a tab is moved within a window.
     * &nbsp
     * Only one move event is fired, representing the tab the user directly moved. Move events are not fired for
    ...
    _this2.onMoved = new _event.default(_this2, 'onMoved');
    /**
     * Fired when a tab is closed.
     *
     * @see {@link https://developer.chrome.com/extensions/tabs#event-onRemoved}
    ...
    _this2.onRemoved = new _event.default(_this2, 'onRemoved');
    /**
     * Fired when a tab is replaced with another tab due to prerendering or instant.
     * &nbsp
     * This event may not be relevant for or supported by browsers other than Chrome.
    ...
    _this2.onReplaced = new _event.default(_this2, 'onReplaced');
    /**
     * Fires when the selected tab in a window changes.
     * &nbsp
     * @deprecated Deprecated, use {@link onActivated} instead.
    ...
    _this2.onSelectionChanged = new _event.default(_this2, 'onSelectionChanged');
    /**
     * Fired when a tab is updated.
     *
     * @see {@link https://developer.chrome.com/extensions/tabs#event-onUpdated}
    ...
    _this2.onUpdated = new _event.default(_this2, 'onUpdated');
    /**
     * Fired when a tab is zoomed.
     *
     * @see {@link https://developer.chrome.com/extensions/tabs#event-onZoomChange}
    ...
    _this2.onZoomChange = new _event.default(_this2, 'onZoomChange'); // endregion
  ...
  _createClass(Tabs, [{
    key: "captureTab",
    value: function captureTab(tabId, options) {
    ...
    value: function captureVisibleTab(windowId, options) {
    ...
    key: "connect",
    value: function connect(tabId, connectInfo) {
      var instance = this.$call('connect', tabId, connectInfo);

      if ((0, _isNil.default)(instance)) {
        return null;
      }

      return new _port.Port(instance, {
    ...
    key: "detectLanguage",
    value: function detectLanguage(tabId) {
    ...
    key: "duplicate",
    value: function duplicate(tabId) {
    ...
    key: "executeScript",
    value: function executeScript(tabId, details) {
    ...
    key: "getAllInWindow",
    value: function getAllInWindow(windowId) {
    ...
    key: "getSelected",
    value: function getSelected(windowId) {
    ...
    key: "getZoomSettings",
    value: function getZoomSettings(tabId) {
    ...
    key: "highlight",
    value: function highlight(highlightInfo) {
    ...
    key: "insertCSS",
    value: function insertCSS(tabId, details) {
    ...
    key: "move",
    value: function move(tabIds, moveProperties) {
    ...
    key: "query",
    value: function query(queryInfo) {
    ...
    key: "reload",
    value: function reload(tabId, reloadProperties) {
    ...
    key: "removeCSS",
    value: function removeCSS(tabId, details) {
    ...
    key: "saveAsPDF",
    value: function saveAsPDF(pageSettings) {
    ...
    key: "sendMessage",
    value: function sendMessage(tabId, message, options) {
    ...
    key: "sendRequest",
    value: function sendRequest(tabId, request) {
    ...
    key: "setZoom",
    value: function setZoom(tabId, zoomFactor) {
    ...
    key: "setZoomSettings",
    value: function setZoomSettings(tabId, zoomSettings) {
    ...
    key: "toggleReaderMode",
    value: function toggleReaderMode(tabId) {
...
exports.Tabs = Tabs;
Object.defineProperty(Tabs, "Title", {
  configurable: true,
  enumerable: true,
  writable: true,
  value: 'Tabs'
...
Object.defineProperty(Tabs, "Compatibility", {
  configurable: true,
  enumerable: true,
  writable: true,
  value: _tabs.default
