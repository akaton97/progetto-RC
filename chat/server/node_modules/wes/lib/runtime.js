...
Object.defineProperty(exports, "RuntimeCompatibility", {
  enumerable: true,
  get: function get() {
    return _runtime.default;
  }
});
exports.default = exports.Runtime = exports.OnRestartRequiredReason = exports.OnInstalledReason = exports.RequestUpdateCheckStatus = exports.PlatformOs = exports.PlatformNaclArch = exports.PlatformArch = void 0;
...
function (_Base) {
  ...
  function Runtime() {
    ...
    _this = _possibleConstructorReturn(this, (Runtime.__proto__ || Object.getPrototypeOf(Runtime)).call(this, options)); // region Events
    ...
    _this.onBrowserUpdateAvailable = new _event.default(_this, 'onBrowserUpdateAvailable');
    /**
     * Fired when a connection is made with either an extension process or a content script.
     *
     * @see {@link https://developer.chrome.com/extensions/runtime#event-onConnect}
    ...
    _this.onConnect = new _event.default(_this, 'onConnect');
    /**
    ...
    _this.onConnectExternal = new _event.default(_this, 'onConnectExternal');
    /**
    ...
    _this.onInstalled = new _event.default(_this, 'onInstalled');
    /**
     * Fired when a message is sent from either an extension process or a content script.
     *
     * @see {@link https://developer.chrome.com/extensions/runtime#event-onMessage}
    ...
    _this.onMessage = new _event.default(_this, 'onMessage');
    /**
     * Fired when a message is sent from another extension. Cannot be used in a content script.
     *
     * @see {@link https://developer.chrome.com/extensions/runtime#event-onMessageExternal}
    ...
    _this.onMessageExternal = new _event.default(_this, 'onMessageExternal');
    /**
    ...
    _this.onRestartRequired = new _event.default(_this, 'onRestartRequired');
    /**
    ...
    _this.onStartup = new _event.default(_this, 'onStartup');
    /**
    ...
    _this.onSuspend = new _event.default(_this, 'onSuspend');
    /**
    ...
    _this.onSuspendCanceled = new _event.default(_this, 'onSuspendCanceled');
    /**
    ...
    _this.onUpdateAvailable = new _event.default(_this, 'onUpdateAvailable'); // endregion
  ...
  _createClass(Runtime, [{
     ...
     */
    value: function connect(extensionId, connectInfo) {
      var instance = this.$call('connect', extensionId, connectInfo);
    ...
    key: "connectNative",
    value: function connectNative(application) {
      var instance = this.$call('connectNative', application);
    ...
    key: "getPackageDirectoryEntry",
    value: function getPackageDirectoryEntry() {
    ...
    key: "requestUpdateCheck",
    value: function requestUpdateCheck() {
    ...
    key: "sendMessage",
    value: function sendMessage(extensionId, message, options) {
    ...
    value: function sendNativeMessage(application, message) {
...
Object.defineProperty(Runtime, "Title", {
  configurable: true,
  enumerable: true,
  writable: true,
  value: 'Runtime'
...
Object.defineProperty(Runtime, "Compatibility", {
  configurable: true,
  enumerable: true,
  writable: true,
