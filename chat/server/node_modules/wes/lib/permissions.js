...
Object.defineProperty(exports, "PermissionsCompatibility", {
  enumerable: true,
  get: function get() {
    return _permissions.default;
  }
});
exports.default = exports.Permissions = void 0;

var _permissions = _interopRequireDefault(require("mdn-browser-compat-data/webextensions/api/permissions.json"));
...
function (_Base) {
  ...
  function Permissions() {
    ...
    _this = _possibleConstructorReturn(this, (Permissions.__proto__ || Object.getPrototypeOf(Permissions)).call(this, options));
    /**
     * Fired when the extension is granted new permissions.
     *
     * @see {@link https://developer.chrome.com/extensions/permissions#event-onAdded}
    ...
    _this.onAdded = new _event.default(_this, 'onAdded');
    /**
     * Fired when some permissions are removed from the extension.
     *
     * @see {@link https://developer.chrome.com/extensions/permissions#event-onRemoved}
    ...
    _this.onRemoved = new _event.default(_this, 'onRemoved');
    return _this;
  }
  /**
  ...
  _createClass(Permissions, [{
    key: "contains",
    value: function contains(permissions) {
    ...
    key: "remove",
    value: function remove(permissions) {
    ...
    key: "request",
    value: function request(permissions) {
...
Object.defineProperty(Permissions, "Title", {
  configurable: true,
  enumerable: true,
  writable: true,
  value: 'Permissions'
});
Object.defineProperty(Permissions, "Name", {
  configurable: true,
  enumerable: true,
  writable: true,
  value: 'permissions'
});
Object.defineProperty(Permissions, "Compatibility", {
  configurable: true,
  enumerable: true,
  writable: true,
  value: _permissions.default
});
